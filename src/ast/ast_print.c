...
static void print_aux(FILE *f, struct node *ast, int* encountered, int act)
{
    char *args[33] =
    {
        "IF", "THEN", "ELSE", "FI", "LOGICAND", "SEMI",
        "WHILE","FOR","UNTIL", "CASE", "DO", "DONE", "WORD", "ASSIGNW",
        "ENDOF","PIPE","LOGOR", "AND","IN", "ESAC", "ELIF", "HERED", "IONUM",
        "COND","ROOT","REDIR", "OPENPAR", "CLOSEPAR", "OPENBRA", "CLOSEBRA",
